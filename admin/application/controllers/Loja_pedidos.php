...
class Loja_pedidos extends TEC_Controller {
    ...
    public function lista()
    {
        ...
        //var_dump($data); exit;
        $this->montaTela('loja/pedidos/lista', $data);
    }
    ...
    public function editar_pedido()
    {
        ...
        $this->load->view('loja/pedidos/editar_pedido', $data);
    ...
    public function detalhes_pedido()
    {
        ...
        $data['pedido'] = $this->pedidos_model->get_pedido($this->input->get('id'));
            ...
            $this->load->view('loja/pedidos/impressao_pedido', $data);
        }else{
            $this->montaTela('loja/pedidos/detalhes_pedido', $data);
        }
    }
