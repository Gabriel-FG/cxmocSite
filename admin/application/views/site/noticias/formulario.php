                         ...
                         <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="descricao" class="form-control" value="<?php echo (isset($noticia)) ? $noticia->descricao : '' ?>">
                                </div>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 preview-image">
                                <div class="lightBoxGallery">
                                    <?php if (isset($noticia)): ?>
                                        <img id="img-show" src="<?php echo base_url(array('../', 'assets', 'images', 'imgs_xadrez', $noticia->imagem)) ?>">
                                    <?php endif ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="conteudo" class="summernote"><?php echo isset($noticia) ? $noticia->conteudo : '' ?></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="hr-line-dashed"></div>
