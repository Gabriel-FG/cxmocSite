                            ...
                            ?>
                                        <tr class="gradeC" id="item-<?php echo $noticia->id ?>">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?php echo base_url("site/excluir-noticia") ?>" class="btn btn-default btn-icon-action delete-item" data-item="<?php echo $noticia->id ?>" data-toggle="tooltip" data-placement="bottom" title="Excluir"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                            <?php
                                    }
