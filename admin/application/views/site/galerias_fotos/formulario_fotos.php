        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form action="<?php echo base_url(array('site', 'salvar-fotos')) ?>" method="post" id="form-cadastro-foto" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-12 error-file">
                                ...
                                <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                    ...
                                    <span class="input-group-addon btn btn-default btn-file">
                                        ...
                                        <input type="file" id="imagem" name="imagem[]" class="file" accept="image/*" multiple />
                                    </span>
                                            ...
                                            <?php foreach ($fotos as $key => $foto): ?>
                                                <div class="col-sm-2 server">
                                                    <div class="container-img">
                                                        <span class="close-img fa fa-times-circle" data-id="<?php echo $foto->id ?>" data-nome="<?php echo $foto->imagem ?>"></span>
                                                        <img id="img-show img-responsive" src="<?php echo base_url(array('../', 'files', 'uploads', 'galerias-fotos', $foto->small_thumb)) ?>">
                                                    </div>
                                                </div>
                                            <?php endforeach; ?>
                                        <?php endif ?>
