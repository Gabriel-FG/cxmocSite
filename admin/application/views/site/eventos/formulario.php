                        ...
                        <div class="row">
                            <div class="col-sm-12 preview-image">
                                <div class="lightBoxGallery">
                                    <?php if (isset($evento)): ?>
                                        <img id="img-show" src="<?php echo base_url(array('../', 'files', 'uploads', 'eventos', $evento->imagem)) ?>">
                                    <?php endif ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="conteudo" class="summernote"><?php echo isset($evento) ? $evento->conteudo : '' ?></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="hr-line-dashed"></div>
