        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form action="<?php echo base_url("site/add-fotos") ?>" method="post" id="form-cadastro-noticia" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-sm-12 error-file">
                                <label class="control-label">Imagens Cadastradas:</label>
                                <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                    ...
                                    <span class="input-group-addon btn btn-default btn-file">
                                        <span class="fileinput-new">Selecionar Nova Imagem</span>
                                        <span class="fileinput-exists">Alterar</span>
                                        <input type="file" id="noticia" name="imagem" class="file" />
                                    </span>
                            ...
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <div class="text-right">
                                        <a href="<?php echo base_url("site/galeria") ?>" class="btn btn-white">Cancelar</a>
